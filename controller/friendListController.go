...
// 传入参数返回
func FirendListResp(c *gin.Context, code int, msg string, userList []service.User) {
...
func GetFriendList(c *gin.Context) {
	...
	// 2、验证参数
	if token == "" || userId == "" {
		FirendListResp(c, -1, "请求参数错误", []service.User{})
		return
	}
	...
	if cnt == 0 {
		FirendListResp(c, -1, "非法用户", []service.User{})
		return
	}
	...
	if err != nil {
		FirendListResp(c, -1, "无效token", []service.User{})
		return
	}
	...
	if err != nil {
		FirendListResp(c, -1, "获取好友列表失败", []service.User{})
		return
	}
